#!/bin/bash
#SBATCH --job-name=sw_l3_run_lr2e-05_lam0.1_eps-1
#SBATCH --account=def-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=3:00:00
#SBATCH --output=output/sweep_l3_run_lr2e-05_lam0.1_eps-1_%j.out
...
export WANDB_RUN_ID=f6a0c5be95d246d09e77f3bfc0ce611a
export WANDB_RUN_NAME="l3_run_lr2e-05_lam0.1_eps-1"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/l3_run_lr2e-05_lam0.1_eps-1_finetuned_llm"
