#!/bin/bash
#SBATCH --job-name=sw_heldout_autodan_l3_run_lr2e-05_lam3_eps0
#SBATCH --account=rrg-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=6:00:00
#SBATCH --output=output/sweep_heldout_autodan_l3_run_lr2e-05_lam3_eps0_%j.out
...
export WANDB_RUN_ID=5d27705511c94cc0baa296d50695e3f5
export WANDB_RUN_NAME="heldout_autodan_l3_run_lr2e-05_lam3_eps0"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/heldout_autodan_l3_run_lr2e-05_lam3_eps0_finetuned_llm"
...
python "$TRAIN_PY" \
    ...
    --lora-rank 8 \
    --total-epochs 2 \
    --training-shuffle-seed 1920855812 \
