#!/bin/bash
#SBATCH --job-name=sw_heldout_pair_l3_run_lr2e-05_lam0_eps0_pertlm
#SBATCH --account=def-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=4:00:00
#SBATCH --output=output/sweep_heldout_pair_l3_run_lr2e-05_lam0_eps0_pertlm_%j.out
...
export WANDB_RUN_ID=247b20350ff240169d092108d16cf7c1
export WANDB_RUN_NAME="heldout_pair_l3_run_lr2e-05_lam0_eps0_pertlm"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/heldout_pair_l3_run_lr2e-05_lam0_eps0_pertlm_finetuned_llm"
...
python "$TRAIN_PY" \
    ...
    --lora-rank 8 \
    --total-epochs 2 \
    --training-shuffle-seed 495150898 \
