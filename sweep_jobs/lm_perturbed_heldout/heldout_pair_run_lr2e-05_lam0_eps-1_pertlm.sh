#!/bin/bash
#SBATCH --job-name=sw_heldout_pair_run_lr2e-05_lam0_eps-1_pertlm
#SBATCH --account=rrg-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=12:00:00
#SBATCH --output=output/sweep_heldout_pair_run_lr2e-05_lam0_eps-1_pertlm_%j.out
...
export WANDB_RUN_ID=d00a4ba995cd4187b8ee26fb86609667
export WANDB_RUN_NAME="heldout_pair_run_lr2e-05_lam0_eps-1_pertlm"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/heldout_pair_run_lr2e-05_lam0_eps-1_pertlm_finetuned_llm"
...
# ----------------------------
BENIGN_TMP="${SLURM_TMPDIR}/frr_eval_input_heldout_pair_run_lr2e-05_lam0_eps-1_pertlm.csv"
...
HARMFUL_OUT_STEM_EP5="${EVAL_OUT_DIR}/heldout_pair_run_lr2e-05_lam0_eps-1_pertlm_epoch5_val_output"
BENIGN_OUT_STEM_EP5="${EVAL_OUT_DIR}/heldout_pair_run_lr2e-05_lam0_eps-1_pertlm_epoch5_frr_output"
METRICS_OUT_EP5="${EVAL_OUT_DIR}/heldout_pair_run_lr2e-05_lam0_eps-1_pertlm_epoch5_metrics.tsv"
...
python - "${HARMFUL_OUT_STEM_EP5}.csv" "${BENIGN_OUT_STEM_EP5}.csv" "$METRICS_OUT_EP5" \
    "heldout_pair_run_lr2e-05_lam0_eps-1_pertlm" "2e-05" "0.0" "-1.0" "empty" "perturbed" "5" <<'PY'
import sys
import pandas as pd
...
echo "Eval epochs: 5"
echo "Per-epoch metrics in: ${EVAL_OUT_DIR}/heldout_pair_run_lr2e-05_lam0_eps-1_pertlm_epoch<N>_metrics.tsv"
