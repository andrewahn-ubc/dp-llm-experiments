#!/bin/bash
#SBATCH --job-name=sw_heldout_pair_l3_run_lr2e-05_lam0.1_eps-1
#SBATCH --account=def-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=3:00:00
#SBATCH --output=output/sweep_heldout_pair_l3_run_lr2e-05_lam0.1_eps-1_%j.out
...
export WANDB_RUN_ID=8c8e938c1916415983e3340125b75a8c
export WANDB_RUN_NAME="heldout_pair_l3_run_lr2e-05_lam0.1_eps-1"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/heldout_pair_l3_run_lr2e-05_lam0.1_eps-1_finetuned_llm"
