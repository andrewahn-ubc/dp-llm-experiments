#!/bin/bash
#SBATCH --job-name=sw_heldout_autodan_run_lr2e-05_lam0_eps-1
#SBATCH --account=rrg-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=12:00:00
#SBATCH --output=output/sweep_heldout_autodan_run_lr2e-05_lam0_eps-1_%j.out
...
export WANDB_RUN_ID=ea01ea3877d94364bb6a93dd7afd945e
export WANDB_RUN_NAME="heldout_autodan_run_lr2e-05_lam0_eps-1"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/heldout_autodan_run_lr2e-05_lam0_eps-1_finetuned_llm"
...
# ----------------------------
BENIGN_TMP="${SLURM_TMPDIR}/frr_eval_input_heldout_autodan_run_lr2e-05_lam0_eps-1.csv"
...
HARMFUL_OUT_STEM_EP5="${EVAL_OUT_DIR}/heldout_autodan_run_lr2e-05_lam0_eps-1_epoch5_val_output"
BENIGN_OUT_STEM_EP5="${EVAL_OUT_DIR}/heldout_autodan_run_lr2e-05_lam0_eps-1_epoch5_frr_output"
METRICS_OUT_EP5="${EVAL_OUT_DIR}/heldout_autodan_run_lr2e-05_lam0_eps-1_epoch5_metrics.tsv"
...
python - "${HARMFUL_OUT_STEM_EP5}.csv" "${BENIGN_OUT_STEM_EP5}.csv" "$METRICS_OUT_EP5" \
    "heldout_autodan_run_lr2e-05_lam0_eps-1" "2e-05" "0.0" "-1.0" "empty" "clean" "5" <<'PY'
import sys
import pandas as pd
...
echo "Eval epochs: 5"
echo "Per-epoch metrics in: ${EVAL_OUT_DIR}/heldout_autodan_run_lr2e-05_lam0_eps-1_epoch<N>_metrics.tsv"
