#!/bin/bash
#SBATCH --job-name=sw_l3_run_lr2e-05_lam3_eps0
#SBATCH --account=def-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=4:00:00
#SBATCH --output=output/sweep_l3_run_lr2e-05_lam3_eps0_%j.out
...
export WANDB_RUN_ID=a468e19788564a08a7921f1854aca8f8
export WANDB_RUN_NAME="l3_run_lr2e-05_lam3_eps0"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/l3_run_lr2e-05_lam3_eps0_finetuned_llm"
...
python "$TRAIN_PY" \
    ...
    --lora-rank 8 \
    --total-epochs 2 \
    --training-shuffle-seed 307593824 \
