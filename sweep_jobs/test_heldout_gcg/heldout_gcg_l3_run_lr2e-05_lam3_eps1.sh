#!/bin/bash
#SBATCH --job-name=sw_heldout_gcg_l3_run_lr2e-05_lam3_eps1
#SBATCH --account=def-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=6:00:00
#SBATCH --output=output/sweep_heldout_gcg_l3_run_lr2e-05_lam3_eps1_%j.out
...
export WANDB_RUN_ID=72ce0f4f07fe49918772e0dd2626c9b1
export WANDB_RUN_NAME="heldout_gcg_l3_run_lr2e-05_lam3_eps1"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/heldout_gcg_l3_run_lr2e-05_lam3_eps1_finetuned_llm"
...
python "$TRAIN_PY" \
    ...
    --lora-rank 8 \
    --total-epochs 2 \
    --training-shuffle-seed 1796170295 \
