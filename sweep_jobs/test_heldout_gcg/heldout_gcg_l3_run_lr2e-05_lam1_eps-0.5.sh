#!/bin/bash
#SBATCH --job-name=sw_heldout_gcg_l3_run_lr2e-05_lam1_eps-0.5
#SBATCH --account=def-mijungp
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=6
#SBATCH --mem=40G
#SBATCH --time=4:00:00
#SBATCH --output=output/sweep_heldout_gcg_l3_run_lr2e-05_lam1_eps-0.5_%j.out
...
export WANDB_RUN_ID=2bae4f18c9e048d187d8530e5c8863a9
export WANDB_RUN_NAME="heldout_gcg_l3_run_lr2e-05_lam1_eps-0.5"

export FINETUNED_BASE="$SCRATCH/dp-llm-sweep/heldout_gcg_l3_run_lr2e-05_lam1_eps-0.5_finetuned_llm"
...
python "$TRAIN_PY" \
    ...
    --lora-rank 8 \
    --total-epochs 2 \
    --training-shuffle-seed 1425528422 \
